This was a branch for testing a prompting format with ChatGPT. Originally the idea was to integrate to Google's own Gemini service but I found that the functionality lacked features vs ChatGPT. 
